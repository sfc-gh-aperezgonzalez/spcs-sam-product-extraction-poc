...
[📹 Watch Demo: SAM Product Extraction](./assets/demo.mov)

> See the SAM product extraction in action - extracting clean product regions from retail ads in ~5 seconds per image on Snowflake SPCS GPU.
